...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog("Piranhas are more " + adjective, "during the day, so cross the river at night. Piranhas are attracted to fresh" + liquid, "and will most likely take a bite out of your" + bodypart , "if you." + verb , "whatever you do, if you have an open wound, try to find another way to get back in the" + place, ". goodluck!" );
		//JOptionPane.showMessageDialog(null,liquid);
		//JOptionPane.showMessageDialog(null,bodypart);
		//JOptionPane.showMessageDialog(null, verb);
		...
		//"likely take a bite out of your [+] if you [verb]. Whatever\n"  +
